...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="theme/images/icon/mollogo21.png" alt="Ministry Of Labour" />
                </a>
            </div>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="#">
                                <i class="far fa-check-square"></i>History Of Cases</a>
                        </li>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-12-12">
                                <div class="copyright">
                                    <p>Copyright © 2021 All rights reserved Template by IT Department  <a href="http://mol.gov.jo">MOL.gov.jo</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
